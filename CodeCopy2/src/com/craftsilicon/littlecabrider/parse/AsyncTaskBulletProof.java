...
@SuppressLint("NewApi")
public class AsyncTaskBulletProof extends AsyncTask<String, String, String> {
	private Context context;
	String fromActivity = "";
	String fromMenu     = "";
	PreferenceHelper am;
	public AsyncTaskBulletProof(Context context) {
	...
	protected String doInBackground(String... urls) {
		...
		AndyUtils.log("todecrypt-encrpyt", ""+QueryString);
		...
		String URLCommand 		 = Const.ELMA_ADD_CARD_URL;
			...
			//log("returned: less tha 3"+ret);
				...
				if(fromMenu.contains("GETAUTHSMS")){
					...
					if (status.equals("000")) {
						...
						log("fromActivity:" + fromActivity + ":SMSCODE:" + SMSCODE);
