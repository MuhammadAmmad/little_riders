...
public class Const {
	...
	//
	//AIzaSyAau2n1QXgsJIN7uGJb6epmN7_0hKf4CnA
	
	//AIzaSyDPsszxNAyHk-lol2lSS4drVUu2w3zTq1g
	//AIzaSyCpurBRmR_MgwSBzUkKDomPmWnaA5wy27w - prev
	//
	//kb account AIzaSyD5Y-7brfHEfVEE0-HDuUCK1sPlFZAByzI
	
	
	//AIzaSyD5Y-7brfHEfVEE0-HDuUCK1sPlFZAByzI
	public static final String PLACES_AUTOCOMPLETE_API_KEY = "AIzaSyBkRLXTdX4c-U-uolXPbB2ITjOByUBB2jo"; // 
																										// "AIzaSyCOfZ0gAxb71Ouwu0Ckbr-XkmciqnL_mKk";

	// map
	public static final String TAG = "Little Cab";
	...
	public static final String PK  	 = "ov1zc38GWGTKFkALNj+kLg==";
	public static final String RK    = "iON51/AtYZP+MWvUzgXTAw==";
	public static final String ELMA_ADD_CARD_URL="https://elma.bz/Elmawebserver/LittleRider.aspx";
	
	// Fare Estimation Action Type
	  public static final String NEW_DESTINATION_ACTION_TYPE="CHECK NEW DESTINATION";
	  public static final String CONFIRM_RIDE_ACTION_TYPE="CONFIRM RIDE";
	...
	public class ServiceType {
		...
		/* ELMA ADD CARD URL*/
		public static final String ELMA_ADD_CARD_URL="https://elma.bz/Elmawebserver/LittleRider.aspx";
		private static final String HOST_URL = "http://little.bz/";
		// http://fb.craftsilicon.com/taxi/public/
		// http://kjbsoft.com/rms/www/public/
		...
		public static final String REGISTER = "https://elma.bz/Elmawebserver/LittleRider.aspx";
		...
		public static final String CREATE_FUTURE_REQUEST = BASE_URL + "createfuturerequest";
		...
		public static final String RATE_KEVIN="http://196.43.248.9:9001/LittleRider.aspx";
		...
		public static final String ISCORPORATE = BASE_URL + "iscorporate";
		public static final String CONFIRMPAYMENT = BASE_URL + "confirmpayment";
	...
	public class ServiceCode {
		public static final int CONFIRM_TRIP = 1000;
		public static final int REGISTER = 1;
		public static final int LOGIN = 2;
		public static final int GET_ROUTE = 3;
		public static final int ADD_CARD = 6;
		public static final int GET_CARD=4;
		public static final int GET_BANKS=5;
		...
		public static final int CONFIRMPAYMENT = 48;
		public static final int ISCORPORATE = 49;
	}

	// service parameters
	public class Params {
		public static final String PAYMENT_STATUS = "paymentstatus";
		public static final String CONFIRM_PAYMENT_MODE = "paymentmode";
		public static final String CONFIRM_PAYMENT_TIP = "tip";
		public static final String CONFIRM_PAYMENT_AMOUNT = "confirmpaymentamount";
		...
		public static final String MYRATING = "rate";
		...
		public static final String TAXI_RADIOSTATION = "radio_stations";		
		public static final String CORPORATENAME = "corporate_name";
		public static final String CORPORATECODE = "corporate_code";
		public static final String TAXI_COLOR = "car_color";
		...
		public static final String MY_MUSIC = "car_music";
		public static final String PASSENGERTYPE = "passenger_type";
