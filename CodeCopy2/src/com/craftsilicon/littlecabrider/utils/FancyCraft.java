...
public class FancyCraft extends Gallery {
    ...
    *//**
    ...
    public FancyCraft(Context context) {
        super(context);
        this.initialize();
    }

    public FancyCraft(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initialize();
        this.applyXmlAttributes(attrs);
    }

    public FancyCraft(Context context, AttributeSet attrs, int defStyle) {
