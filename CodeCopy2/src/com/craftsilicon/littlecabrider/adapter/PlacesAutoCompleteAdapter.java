...
public class PlacesAutoCompleteAdapter extends ArrayAdapter<String> implements
		Filterable {
	public static final String LOG_TAG = "placeadapter";
...
//			sb.append("&types=establishment");
			...
			AppLog.Log(LOG_TAG, "Place Url : " + sb.toString());
		...
		try {
			...
			for (int i = 0; i < predsJsonArray.length(); i++) {
				...
				AppLog.Log(LOG_TAG, "predsjsonarray : " + predsJsonArray.getJSONObject(i).getString("description"));
			}
