...
//		aQuery = new AQuery(context);
	...
	public View getCoverFlowItem(int i, View reuseableView, ViewGroup viewGroup) {
		...
		if (view == null) {
			...
			holderView.ivVehicle = (ImageView) view.findViewById(R.id.ivVehicle);
			view.setTag(holderView);
		} else {
			holderView = (HolderView) view.getTag();
		}

		new AQuery(view).id(holderView.ivVehicle).image(listType.get(i).getIcon(), imageOptions);
		int width = (int) context.getResources().getDimension(R.dimen.image_type_height_width);
