 ...
 */
public class PlacesAutoCompleteAdapter2 extends ArrayAdapter<String> implements
		Filterable {
	public static final String LOG_TAG = "UBER";
	private ArrayList<String> resultList = new ArrayList<String>();;
	Context ctx;

	public PlacesAutoCompleteAdapter2(Context context, int textViewResourceId) {		
	...
	private ArrayList<String> autocomplete(String input) {
		...
		try {
			PreferenceHelper preference = new PreferenceHelper(ctx);
			...
			sb.append("&components=country:" + preference.getMyCountry() + "");
			...
			AndyUtils.log("urll1", sb.toString());
			AndyUtils.log("urll2", url.toString());
